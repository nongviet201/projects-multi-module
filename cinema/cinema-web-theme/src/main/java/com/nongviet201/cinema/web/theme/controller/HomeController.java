...
public class HomeController extends WebController {
    ...
    public HomeController(MovieService movieService, ShowtimeService showtimeService, WebBillControllerService billControllerService, WebVerifyService verifyService, WebUserControllerService userControllerService) {
        super(movieService, showtimeService, billControllerService, verifyService, userControllerService);
    }
}
