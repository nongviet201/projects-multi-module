...
public class HomeController extends WebController {
    ...
    public HomeController(MovieService movieService, WebShowtimeControllerService webShowtimeControllerService, WebBillControllerService webBillControllerService, WebUserControllerService webUserControllerService, WebVerifyService verifyService, PostService postService) {
        super(movieService, webShowtimeControllerService, webBillControllerService, webUserControllerService, verifyService, postService);
    }
}
